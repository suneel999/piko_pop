...
$route['analytics_track/(:any)'] = 'analytics_track/$1';

$route['recipes'] = 'recipes/index';
$route['recipe/(:any)'] = 'recipes/detail/$1';

$route['feedback/guest'] = 'feedback/guest';
$route['feedback/guest_submit'] = 'feedback/guest_submit';
