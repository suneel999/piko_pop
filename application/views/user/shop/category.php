    ...
    <div class="page-breadcrumb">
        <div class="page-container page-breadcrumb-inner">
            <nav class="flex items-center gap-2 text-sm flex-wrap">
                ...
                <i class="fa-solid fa-chevron-right text-[10px] text-gray-400"></i>
                <span class="text-dark font-medium"><?php echo htmlspecialchars($category->category_name); ?></span>
            </nav>
        </div>
    </div>
    ...
    <div class="page-container shop-shell">
        <div class="shop-header">
            <div class="shop-header-copy">
                <h1 class="shop-title"><?php echo htmlspecialchars($category->category_name); ?></h1>
                <p class="shop-subtitle">Browse products in this collection</p>
                <p class="shop-meta">
        ...
        <div class="shop-filters">
            <p class="shop-filter-label">Subcategories</p>
            <div class="shop-filter-list">
                <?php foreach ($subcategories as $subcat): ?>
                <a href="<?php echo category_url($subcat); ?>" class="shop-filter-chip">
        ...
        <div class="shop-products">
            ...
            <div class="shop-pagination">
                ...
                <a href="<?php echo $base_url . $separator . 'page=' . ($current_page - 1); ?>" class="shop-page-btn" aria-label="Previous page">
                ...
                <?php if ($start_page > 1): ?>
                <a href="<?php echo $base_url . $separator . 'page=1'; ?>" class="shop-page-btn">1</a>
                ...
                <?php else: ?>
                <a href="<?php echo $base_url . $separator . 'page=' . $i; ?>" class="shop-page-btn"><?php echo $i; ?></a>
                <?php endif; ?>
                <?php endfor; ?>

                <?php if ($end_page < $total_pages): ?>
                <?php if ($end_page < $total_pages - 1): ?><span class="shop-page-ellipsis">...</span><?php endif; ?>
                <a href="<?php echo $base_url . $separator . 'page=' . $total_pages; ?>" class="shop-page-btn"><?php echo $total_pages; ?></a>
                <?php endif; ?>

                <?php if ($current_page < $total_pages): ?>
                <a href="<?php echo $base_url . $separator . 'page=' . ($current_page + 1); ?>" class="shop-page-btn" aria-label="Next page">
            ...
            <div class="shop-empty">
                ...
                <h3 class="shop-empty-title">No products in this collection</h3>
                <p class="shop-empty-text">This category is waiting for new arrivals.</p>
