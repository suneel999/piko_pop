!function (a) {
    ...
    function t(e) {
        1 == a("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (a("html").removeAttr("dir"),
            ...
            a("#bootstrap-style").attr("href", base_url + "assets/css/bootstrap.min.css"),
            a("#app-style").attr("href", base_url + "assets/css/app.min.css"),
            sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == a("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (a("html").removeAttr("dir"),
                ...
                a("#rtl-mode-switch").prop("checked", !1),
                a("#dark-rtl-mode-switch").prop("checked", !1),
                a("#bootstrap-style").attr("href", base_url + "assets/css/bootstrap-dark.min.css"),
                a("#app-style").attr("href", base_url + "assets/css/app-dark.min.css"),
                sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == a("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (a("#light-mode-switch").prop("checked", !1),
                    a("#dark-mode-switch").prop("checked", !1),
                    a("#dark-rtl-mode-switch").prop("checked", !1),
                    a("#bootstrap-style").attr("href", base_url + "assets/css/bootstrap-rtl.min.css"),
                    a("#app-style").attr("href", base_url + "assets/css/app-rtl.min.css"),
                    a("html").attr("dir", "rtl"),
                    sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == a("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (a("#light-mode-switch").prop("checked", !1),
                        a("#rtl-mode-switch").prop("checked", !1),
                        a("#dark-mode-switch").prop("checked", !1),
                        a("#bootstrap-style").attr("href", base_url + "assets/css/bootstrap-dark-rtl.min.css"),
                        a("#app-style").attr("href", base_url + "assets/css/app-dark-rtl.min.css"),
                        a("html").attr("dir", "rtl"),
